...
excel_chart=load_workbook(Filename)
      ...
      for i in range(2,5): 
        for j in range(3,7):
          if(SymptomVar1.get()==symptom_sheet.cell(row=i,column=j).value):
              Answersymptom1=tkinter.Label(frame2,text=symptom_sheet.cell(row=i,column=j).value)
      ...
      for i in range(2,5): 
        for j in range(3,7):
          if(SymptomVar2.get()==symptom_sheet.cell(row=i,column=j).value):
              Answersymptom2=tkinter.Label(frame2,text=symptom_sheet.cell(row=i,column=j).value)
      ...
      for i in range(2,5): 
        for j in range(3,7):
          if(SymptomVar3.get()==symptom_sheet.cell(row=i,column=j).value):
               Answersymptom3=tkinter.Label(frame2,text=symptom_sheet.cell(row=i,column=j).value)
